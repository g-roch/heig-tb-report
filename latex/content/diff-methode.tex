...
\begin{nota}{Cas d'utilisation}
	...
	au choix effectuer dans ce travail de Bachelor) sont décrit dans le \aaref{chap:usecase}.
\end{nota}
  ...
  Les tableaux \aref{fig:critere:manip:example} montrent comment un petit nombre d'électeur 
  ...
  Les tableaux \aref{fig:critere:corruption:example} montrent comment corrompre un petit nombre d'électeur 
  ...
  Les simulations de scrutins on été réaliser grâce à du code écrit pour l'occasion disponible 
  ...
  \tabcritere%
    {\cellcolor{red}trés mauvais}{Une grande part de la population (>50\%) peut être contre l'élu·e.}%
    {\cellcolor{red}mauvais}{Les petits candidats «~vols~» des voix aux autres candidats proches d'eux politiquement.}%
  ...
  \tabcritere%
    ...
    {\cellcolor{orange}moyen}{Ne respecte pas ce critère, mais essaye de minimiser les personnes très mécontentes du résultat.}%
    {\cellcolor{orange}moyen}{Les électeurs on intérêt à classé moins bien leurs seconds choix pour avantage leur candidat favori.}
  ...
  \tabcritere%
    ...
    {\cellcolor{green}bien}{Lorsqu'il y a un unique vainqueur, la méthode est résistant au petit candidat.}%
  ...
  \tabcritere%
    ...
    {\cellcolor{red}mauvais}{Seul l'avis médian est pris en compte, on peu construire des simulations ou une majorité de personne préférerait un même autre candidat au candidat élu.}%
    {\cellcolor{green!25!yellow}correct}{Le meilleure techniques consiste à donner ses vrai préférences, cependant dans certain cas spécifiques, pour certain votant uniquement, une meilleures stratégie peux exister mais n’est pas évidente}
  ...
  \tabcritere%
    ...
    {\cellcolor{orange}moyen}{Pose globalement les mêmes problèmes que le scrutin majoritaire (\aref{diff:scrutin-majoritaire}), mais est plus complexe à prédire, car il faut prédire tous les tours avant le vote. La meilleure technique de vote se base sur prendre en compte les sondages pour choisir le vote le plus pertinent.}
