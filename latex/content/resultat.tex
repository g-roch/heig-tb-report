...
Le \aaref{tab:verif:nizk} présente les durées nécessaire à la vérification des NIZK pour une élection à 30 candidats en fonction 
...
Un second algorithme (\aaref{lst:perf:resultat-2}) a été écrit pour essayer d'accélerer le 
